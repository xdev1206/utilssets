...
set notermguicolors
if has('termguicolors') " 只在明确支持 truecolor 的终端开启
...
if !has('termguicolors') || &term !~ '256color' " 256色 fallback
...
highlight Search ctermbg=179 ctermfg=235
...
augroup LargeFile
  autocmd!
  autocmd BufReadPre * if getfsize(expand("%")) > 100000 | syntax off | set noswapfile | endif
augroup END
